...
[Official] [B42.13+] [Registry] [BreakingChange]
...
To add these identifiers and use them in scripts, you need to add them using Lua in the `registries.lua` file. This file must be stored in the media folder. **IT MUST HAVE THIS EXACT NAME**, and it is loaded before scripts and before any other Lua files.
...
[Official] [LuaAPI] [Migration]

- Some Lua API has been modified.
- If something has stopped working for you, check the decompiled Java code.
- _There will be more API changes in upcoming unstable patches._

## Scripts

[Official] [BreakingChange] [Inventory]
