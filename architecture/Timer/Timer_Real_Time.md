...
**You do *not* use game time (`getWorldAgeHours`) when you need a real-time cooldown.**
Game time is *scaled* by sandbox settings and therefore **not stable** for anti-spam, anti-loop, or rate-limit logic.
...
## 5. If You *Must* Use Game Time (Not Recommended)
